...
# - The script has to be executed within the `freecad/ship/resources/translations` directory.
...
# - Once done, download the translated files, copy them to `freecad/ship/resources/translations`
...
update_locale() {
	...
	# Using shell expansion to generate a list of files
	FILES="../../resistance{Amadeo,Holtrop}/{PlotAux,TaskPanel}.py \
	../../seakeeping{RAOs,SetMesh}/TaskPanel.py \
       ../../ship{CapacityCurve,GZ,Hydrostatics}/{PlotAux,TaskPanel,Tools}.py \
       ../../shipAreasCurve/{PlotAux,TaskPanel}.py \
       ...
       ../../{TankInstance,WeightInstance,ShipGui,Instance}.py \
       ../ui/*.ui"
