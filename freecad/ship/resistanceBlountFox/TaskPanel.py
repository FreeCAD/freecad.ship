...
class TaskPanel:
    def __init__(self):
        self.name = "Compute resistance prediction Blount & Fox method"
        self.ui = os.path.join(os.path.dirname(__file__),
                               "../resources/ui/",
                               "TaskPanel_resistanceBlountFox.ui")
    ...
    def accept(self):
        ...
        savitsky_check = self.form.add_savitsky_curve.isChecked()
        ...
        if 1 >= eta_p > 0:
            ...
            msg = App.Qt.translate(
                "ship_console", "The propulsive coefficiente cannot be higher than 1"
            )
        ...
        (drag, speeds, trims, lift, dfriction, dpressure, lam, rein, cfri,
         cpres, ctotal, EKW, BKW, drag_savitsky, speed_savitsky) = (
            BlountFox.blount_and_fox(Beam, Vmin, Vmax, Nspeeds, Displacement,
                                     DeadriseAngle, LCG, trim_step, seamargin, etap))

        PlotAux.Plot(speeds, trims, drag, dfriction, dpressure, cfri, cpres, ctotal, EKW, BKW, drag_savitsky,
    ...
    def setupUi(self):
        ...
        self.form.add_savitsky_curve = self.widget(QtGui.QCheckBox, "add_savitsky_curve")
    ...
    def widget(self, class_id, name):
        ...
        form = mw.findChild(QtGui.QWidget, "BlountFoxTaskPanel")
